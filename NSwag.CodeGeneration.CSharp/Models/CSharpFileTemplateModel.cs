...
namespace NSwag.CodeGeneration.CSharp.Models
{
    ...
    public class CSharpFileTemplateModel
    {
            ...
            CSharpTypeResolver resolver)
        {
            ...
            ApiClientNames = clientTypes.Select(d => d.TypeName).Distinct().ToList();
            Classes = dtoTypes.Concatenate();
        }

        /// <summary>Gets the ApiClientNames.</summary>
        public List<string> ApiClientNames { get; }
        /// <summary>Gets the namespace.</summary>
        public string Namespace => _settings.CSharpGeneratorSettings.Namespace ?? string.Empty;
        /// <summary>Gets the ClientName.</summary>
        public string ClientName => _settings.ClientName ?? "ApiClient";
