...
namespace NSwag.Commands.CodeGeneration
{
    ...
    public class OpenApiToCSharpClientCommand : OpenApiToCSharpCommandBase<CSharpClientGeneratorSettings>
    {
        ...
        [Argument(Name = "ClientName", IsRequired = false, Description = "The ClientName class (default=ApiClient).")]
        public string ClientName
        {
            get { return Settings.ClientName; }
            set { Settings.ClientName = value; }
        }
